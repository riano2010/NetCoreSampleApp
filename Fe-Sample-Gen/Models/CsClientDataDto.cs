...
{ 
    /// <summary>
    /// Клиент (Карточка Клиентов)
    /// </summary>
    [DataContract]
    public partial class CsClientDataDto : IEquatable<CsClientDataDto>
    { 
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CsClientDataDto {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CsClientDataDto)obj);
        }

        /// <summary>
        /// Returns true if CsClientDataDto instances are equal
        /// </summary>
        /// <param name="other">Instance of CsClientDataDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsClientDataDto other)
        {
        ...
        public static bool operator ==(CsClientDataDto left, CsClientDataDto right)
        {
